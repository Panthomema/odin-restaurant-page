...
export default function about() {
  ...
  secondRow.innerHTML =
    "Step into a world where culinary limits disappear " +
    "and imagination thrives - At <strong>Whatever</strong>, each dish is a " +
    "journey—whether classic or cosmic. Our chefs craft extraordinary meals " +
    "that delight and inspire - We invite you to experience the " +
  ...
  content.append(firstRow, imgElement, secondRow, thirdRow, greeting);
